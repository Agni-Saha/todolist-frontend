...
export default class Edit extends Component {
    ...
    componentDidMount() {
        Axios.get("http://localhost:3001/todoDB/" + this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(event) {
        ...
        Axios.post("http://localhost:3001/todoDB/update/" + this.props.match.params.id, obj)
            .then(response => {
    ...
    onDelete(event) {
        ...
        Axios.delete("http://localhost:3001/todoDB/delete/" + this.props.match.params.id)
            .then(response => {
                console.log(response.data)
            })
            .catch(error => console.log(error))
